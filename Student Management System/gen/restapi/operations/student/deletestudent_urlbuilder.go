...
// DeletestudentURL generates an URL for the deletestudent operation
...
func (o *DeletestudentURL) Build() (*url.URL, error) {
	...
	var _path = "/Student/deleterecoard/{email}"

	email := o.Email
	if email != "" {
		_path = strings.Replace(_path, "{email}", email, -1)
	} else {
		return nil, errors.New("email is required on DeletestudentURL")
	}
