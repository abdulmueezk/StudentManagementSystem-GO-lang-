...
// DeletestudentParams contains all the bound params for the deletestudent operation
...
type DeletestudentParams struct {
	...
	/*email of student that needs to delete the recoard
	  Required: true
	  In: path
	*/
	Email string
...
func (o *DeletestudentParams) bindEmail(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
