...
// UpdatestudentURL generates an URL for the updatestudent operation
...
func (o *UpdatestudentURL) Build() (*url.URL, error) {
	...
	var _path = "/Student/updaterecoard/{email}"

	email := o.Email
	if email != "" {
		_path = strings.Replace(_path, "{email}", email, -1)
	} else {
		return nil, errors.New("email is required on UpdatestudentURL")
	}
